...
export default function App() {
  ...
  // ============ IFTA VIEW ============
  const renderIFTA = () => {
    // AUTO-CALCULATE from fuel entries - aggregate gallons by state
    ...
    const totalMiles = iftaSummary.reduce((s, d) => s + d.miles, 0);
    const totalGallons = iftaSummary.reduce((s, d) => s + d.gallons, 0);
